...
const INIT_CHECKPOINTS: Checkpoint[] = [{ value: 0, RB: 1000 }, { value: 25, RB: 2500 }, { value: 50, RB: 5000 }, { value: 75, RB: 7500 }, { value: 90, RB: 10000 }]

const Slider: React.FC<SliderProps> = ({ value, onValueChanged, checkPoints = INIT_CHECKPOINTS, isRobiBoost, ...props }) => {
  ...
  return (
    <Wrapper>
      ...
      <BreakePointsWrap>
        {checkPoints?.map((item, index) => <Point key={index.toString()}/>)}
      </BreakePointsWrap>
      <InfoBlock>
        <InfoNode>
      ...
      <RBPrice>price 1{isRobiBoost ? 'RB' : 'SE'} = ${percent.RB} volume</RBPrice>
    </Wrapper>
