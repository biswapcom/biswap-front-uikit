...
export const Default: React.FC = () => {
  ...
  return (
      <>
        ...
        <Row isLight>
          <ButtonMenu activeIndex={index} onItemClick={handleClick} variant="selectLight">
            <ButtonMenuItem>Button 1</ButtonMenuItem>
            <ButtonMenuItem>Button 2</ButtonMenuItem>
            <ButtonMenuItem>Button 3</ButtonMenuItem>
            <ButtonMenuItem>Button 4</ButtonMenuItem>
        ...
        <Row isLight>
          <ButtonMenu activeIndex={index1} onItemClick={handleClick1} scale="sm" variant="selectLight">
            <ButtonMenuItem>Button 1</ButtonMenuItem>
            <ButtonMenuItem>Button 2</ButtonMenuItem>
            <ButtonMenuItem>Button 3</ButtonMenuItem>
            <ButtonMenuItem>Button 4</ButtonMenuItem>
