    ...
    return (React.createElement(StyledButton$1, { onClick: onClick },
        React.createElement(SvgDiag, { viewBox: "0 0 42 42" },
            ...
            React.createElement(Content, null,
                React.createElement(Icon$2S, { width: "20px", color: "currentColor" })))));
};
...
var DefaultSeparator = React.createElement(Icon$3g, { color: "dark500", width: "20px" });
...
var Button = function (props) {
    ...
    var endIconElement = isLoading ? (React.createElement(Icon$1r, { color: "contrast" })) : (endIcon);
    if (isLoading) {
...
var ExpandableButton = function (_a) {
    ...
    return (React.createElement(IconButton, { "aria-label": "Hide or show expandable content", onClick: onClick },
        children,
        expanded ? (React.createElement(Icon$3c, { color: "invertedContrast" })) : (React.createElement(Icon$3j, { color: "invertedContrast" }))));
};
...
var ExpandableLabel = function (_a) {
    var onClick = _a.onClick, expanded = _a.expanded, children = _a.children;
    return (React.createElement(Button, { variant: "text", "aria-label": "Hide or show expandable content", onClick: onClick, endIcon: expanded ? (React.createElement(Icon$3c, { color: "primary" })) : (React.createElement(Icon$3j, { color: "primary" })) }, children));
};
...
var StyledArrow = styled(Icon$3j)(templateObject_6$b || (templateObject_6$b = __makeTemplateObject(["\n  transition: transform 0.4s ease-in-out;\n  transform: ", ";\n"], ["\n  transition: transform 0.4s ease-in-out;\n  transform: ", ";\n"])), function (_a) {
...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(Link, __assign({ external: true }, props),
        children,
        React.createElement(Icon$35, { color: props.color ? props.color : "primary", width: "16px", ml: "4px" })));
};
...
var Pagination = function (_a) {
    ...
    return (React.createElement(PaginationWrap, { className: paginationClass, variant: variant },
        React.createElement(ReactPaginate, { previousLabel: React.createElement(Icon$3d, { color: variant === "light" ? "primary" : "white" }), nextLabel: React.createElement(Icon$3g, { color: variant === "light" ? "primary" : "white" }), forcePage: forcePage, breakLabel: "...", breakClassName: "break-me", pageCount: pageCount, marginPagesDisplayed: marginPagesDisplayed, pageRangeDisplayed: pageRangeDisplayed, onPageChange: handlePageClick, containerClassName: "pagination", activeClassName: "active" })));
};
        ...
        React.createElement(Flex, { position: "relative", justifyContent: title ? "space-between" : "flex-end", mb: isMobile ? "24px" : "32px", alignItems: isMobile ? "flex-end" : "flex-start" },
            ...
            showNavButtons && (React.createElement(Flex, { ml: "8px" },
                React.createElement(NavButton, { scale: "xs", variant: "primary", onClick: function () {
                    ...
                    React.createElement(Icon$3d, { color: "white" })),
                React.createElement(NavButton, { scale: "xs", variant: "primary", ml: "8px", onClick: function () {
                        handleNav("next");
                    } },
                    React.createElement(Icon$3g, { color: "white" })))))));
};
...
var StyledChevronIcon = styled(function (_a) {
    var props = __rest(_a, []);
    return (React.createElement(Icon$3j, __assign({}, props)));
...
var ModalCloseButton = function (_a) {
    ...
    return (React.createElement(IconButton, { variant: "text", onClick: onDismiss, scale: "sm", "aria-label": "Close the dialog" },
        React.createElement(Icon$2S, { color: closeBtnColor || "dark600", width: "24px" })));
};
var ModalBackButton = function (_a) {
    ...
    return (React.createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
        React.createElement(Icon$37, { color: closeBtnColor || "primary" })));
};
            ...
            React.createElement(Alert, { progress: progress, title: title, variant: alertTypeMap[type], onClick: handleRemove },
                React.createElement("div", null,
                    hash && (React.createElement(LinkWrapper, null,
                        ...
                        React.createElement(Icon$35, { ml: "6px", width: "18px", height: "18px", color: "primary" }))),
...
export { Icon$K as AboutBSWOpacityIcon, Icon$L as AboutBSWSolidIcon, Alert, Icon$Q as AnalyticsOpacityIcon, Icon$R as AnalyticsSolidIcon, Icon$36 as ArrowDownIcon, Icon$b as ArrowFiguredIcon, Icon$37 as ArrowLeftIcon, Icon$39 as ArrowRightIcon, Icon$33 as ArrowSkipLeftIcon, Icon$34 as ArrowSkipRightIcon, Icon$35 as ArrowUpForwardIcon, Icon$38 as ArrowUpIcon, Icon$1Y as AuctionIcon, Icon$1W as AuctionOpacityIcon, Icon$1X as AuctionSolidIcon, Icon$x as AuditProtectionOpacityIcon, Icon$w as AuditProtectionSolidIcon, Icon$u as AuditSearchOpacityIcon, Icon$v as AuditSearchSolidIcon, Icon$1r as AutoRenewAnimateIcon, Icon$1u as AutoRenewIcon, Icon$1s as AutoRenewOpacityAnimateIcon, Icon$1v as AutoRenewOpacityIcon, Icon$1t as AutoRenewSolidAnimateIcon, Icon$1w as AutoRenewSolidIcon, Icon$c as AvalancheIcon, Icon$e as BSCIcon, Badge$1 as Badge, Badge as BadgeButton, GridLayout$1 as BaseLayout, BaseMenu, Icon$2l as BellOpacityIcon, Icon$2m as BellSolidIcon, Icon$1M as BlockIcon, Icon$1L as BlockOpacityIcon, Icon$1K as BlockSolidIcon, Icon$s as BlogOpacityIcon, Icon$t as BlogSolidIcon, BodyText, Icon$22 as BookIcon, Icon$20 as BookOpacityIcon, Icon$21 as BookSolidIcon, Box, Breadcrumbs, Icon$3m as BscBlackRoundIcon, Icon$7 as BswIcon, Icon$1h as BurgerCloseIcon, Icon$1i as BurgerIcon, Button, ButtonMenu, ButtonMenuItem, Icon$2L as CalculateIcon, Icon$2N as CalculateOpacityIcon, Icon$2M as CalculateSolidIcon, Card, CardBody, CardFooter, CardHeader, Icon$2u as CardViewIcon, GridLayout as CardsLayout, CarouselButtonsTypes, CarouselHeader, CarouselNumbersBlock, Icon$M as CharityOpacityIcon, Icon$N as CharitySolidIcon, Icon$2r as CheckIcon, Icon$2p as CheckOpacityIcon, Icon$2q as CheckSolidIcon, Checkbox, Icon$3k as ChevronDownCircleOpacityIcon, Icon$3l as ChevronDownCircleSolidIcon, Icon$3j as ChevronDownIcon, Icon$3e as ChevronLeftCircleOpacityIcon, Icon$3f as ChevronLeftCircleSolidIcon, Icon$3d as ChevronLeftIcon, Icon$3h as ChevronRightCircleOpacityIcon, Icon$3i as ChevronRightCircleSolidIcon, Icon$3g as ChevronRightIcon, Icon$3a as ChevronUpCircleOpacityIcon, Icon$3b as ChevronUpCircleSolidIcon, Icon$32 as ChevronUpDoubleIcon, Icon$3c as ChevronUpIcon, Icon$31 as ChevronUpTripleIcon, ClickableElementContainer, Icon$2R as CloseCircleOpacityIcon, Icon$2Q as CloseCircleSolidIcon, Icon$2S as CloseIcon, Icon$g as CoinMarketCapIcon, ColoredToasts, Container$1 as Container, ContainerCarousel, Icon$2b as CopyIcon, Icon$29 as CopyOpacityIcon, Icon$2a as CopySolidIcon, DirectionButton, Icon$y as DocsOpacityIcon, Icon$z as DocsSolidIcon, Dot, Icon$3p as DownloadIcon, Dropdown, DropdownMenuItemType, Icon$1C as EditIcon, Icon$1B as EditOpacityIcon, Icon$1A as EditSolidIcon, Icon$1a as ExchangeOpacityIcon, Icon$1b as ExchangeSolidIcon, ExpandableButton, ExpandableIcon, ExpandableLabel, Icon$18 as ExpertModeOpacityIcon, Icon$19 as ExpertModeSolidIcon, Icon$2s as EyeCloseIcon, Icon$2t as EyeOpenIcon, Icon$i as FacebookIcon, Faqs, Icon$14 as FarmsOpacityIcon, Icon$15 as FarmsSolidIcon, Icon$2x as FavoriteEmptyIcon, Icon$2w as FavoriteSolidIcon, Icon$1$ as FileIcon, Icon$1Z as FileOpacityIcon, Icon$1_ as FileSolidIcon, Icon$25 as FilterIcon, Icon$23 as FilterOpacityIcon, Icon$24 as FilterSolidIcon, Icon$2H as FireIcon, Icon$2F as FireOpacityIcon, Icon$2G as FireSolidIcon, Icon$S as FixedStakingOpacityIcon, Icon$T as FixedStakingSolidIcon, Icon$1P as FlagIcon, Icon$1O as FlagOpacityIcon, Icon$1N as FlagSolidIcon, Flex, Icon$1y as GasIcon, Icon$3 as GiftIcon, Icon$_ as GobletOpacityIcon, Icon$$ as GobletSolidIcon, Grid, HeadText, Heading, Icon$2I as HelpIcon, Icon$2K as HelpOpacityIcon, Icon$2J as HelpSolidIcon, HeroWrapper, Icon$1l as HistoryIcon, Icon$3n as HourglassIcon, IconButton, IconComponent, Icon$10 as IdoOpacityIcon, Icon$11 as IdoSolidIcon, Image, Icon$2E as InfoIcon, Icon$2C as InfoOpacityIcon, Icon$2D as InfoSolidIcon, InlineMenu, InlineMenuContainer, Input$1 as Input, InputGroup, Icon$p as InstagramIcon, ItemTypes, Icon$4 as LanguageIcon, Icon$W as LaunchpadOpacityIcon, Icon$X as LaunchpadSolidIcon, Icon$q as LimitOrderOpacityIcon, Icon$r as LimitOrderSolidIcon, Link, LinkExternal, Icon$1c as LiquidityOpacityIcon, Icon$1d as LiquiditySolidIcon, Icon$1n as ListOpacityIcon, Icon$1m as ListSolidIcon, Icon$2v as ListViewIcon, Icon$6 as LockIcon, Icon$9 as LogoWithTextIcon, Icon$Y as LotteryOpacityIcon, Icon$Z as LotterySolidIcon, MatchBreakpointsProvider, Icon$1z as MedalIcon, Icon$o as MediumIcon, Menu, Icon$2X as MinusCircleOpacityIcon, Icon$2Y as MinusCircleSolidIcon, Icon$2Z as MinusIcon, Modal, ModalBackButton, ModalBody$1 as ModalBody, ModalCloseButton, ModalContainer, ModalHeader, ModalProvider, ModalTitle, ModalV2, ModalV2Context, ModalWithBackground, ModalWrapper, Icon$1D as More2Icon, Icon$1G as MoreHorizontalIcon, Icon$1E as MoreHorizontalOpacityIcon, Icon$1F as MoreHorizontalSolidIcon, Icon$1J as MoreVerticalIcon, Icon$1H as MoreVerticalOpacityIcon, Icon$1I as MoreVerticalSolidIcon, Icon$3o as MouseIcon, Icon$D as MultiPoolOpacityIcon, Icon$C as MultiPoolSolidIcon, Icon$U as NFTEarnOpacityIcon, Icon$V as NFTEarnSolidIcon, Icon$A as NewsOpacityIcon, Icon$B as NewsSolidIcon, NotificationDot, Icon$2e as OptionsOpacityIcon, Icon$2f as OptionsSolidIcon, Overlay, Pagination, PercentSlider, Icon$1 as PerpetualOpacityIcon, Icon as PerpetualSolidIcon, Icon$1x as PlayIcon, Icon$2_ as PlusCircleOpacityIcon, Icon$2$ as PlusCircleSolidIcon, Icon$30 as PlusIcon, Icon$d as PolygonIcon, Icon$16 as PoolsOpacityIcon, Icon$17 as PoolsSolidIcon, Icon$1j as ProductsOpacityIcon, Icon$1k as ProductsSolidIcon, Icon$G as Program10mOpacityIcon, Icon$H as Program10mSolidIcon, Icon$8 as ProjectNameIcon, Icon$f as QuoraIcon, Radio, Icon$n as RedditIcon, Icon$12 as ReferralOpacityIcon, Icon$13 as ReferralSolidIcon, Icon$1q as RefreshIcon, Icon$1p as RefreshOpacityIcon, Icon$1o as RefreshSolidIcon, ResetCSS, Icon$2 as RouteIcon, Icon$2j as SearchOpacityIcon, Icon$2k as SearchSolidIcon, Icon$28 as ShareIcon, Icon$26 as ShareOpacityIcon, Icon$27 as ShareSolidIcon, Skeleton, Slider, SocialShareButton, SocialShareButtonCircle, Icon$E as SpaceAgentOpacityIcon, Icon$F as SpaceAgentSolidIcon, Icon$2i as StarIcon, Icon$2h as StarOpacityIcon, Icon$2g as StarSolidIcon, SubMenu, SubMenuContainer, SubMenuItem, SubMenuItems, Svg, Icon$2B as SwapHorizontalOpacityIcon, Icon$2A as SwapHorizontalSolidIcon, Icon$2z as SwapVerticalOpacityIcon, Icon$2y as SwapVerticalSolidIcon, TabMenu, TabBarItem as TabMenuItem, TableCardSkeleton, Icon$I as TeamOpacityIcon, Icon$J as TeamSolidIcon, Icon$m as TelegramIcon, Terms, Icon$1S as TestIcon, Icon$1R as TestOpacityIcon, Icon$1Q as TestSolidIcon, Text, Icon$a as Ticket2Icon, Icon$h as TikTokIcon, Icon$1V as TimerIcon, Icon$1T as TimerOpacityIcon, Icon$1U as TimerSolidIcon, ToastContainer, Toggle, TooltipHelper, TooltipText, Icon$l as TwitchIcon, Icon$k as TwitterIcon, Icon$5 as UnlockIcon, Icon$1e as UsdLineIcon, Icon$1g as UsdOpacityIcon, Icon$1f as UsdSolidIcon, Icon$2n as UserOpacityIcon, Icon$2o as UserSolidIcon, Icon$2c as VerifiedOpacityIcon, Icon$2d as VerifiedSolidIcon, ViewMode, Icon$O as VotingOpacityIcon, Icon$P as VotingSolidIcon, Icon$2O as WalletOpacityIcon, Icon$2P as WalletSolidIcon, Icon$2T as WarningCycleIcon, Icon$2U as WarningIcon, Icon$2W as WarningOpacityIcon, Icon$2V as WarningSolidIcon, Icon$j as YoutubeIcon, variants$8 as alertVariants, bodyTextScaleMap, coloredVariants, darkTheme as dark, darkColors, formatSpacingAmount, getExternalLinkProps, getPortalRoot, getResponsiveAttrs, getRgba, getThemeValue, headTextScaleMap, isTouchDevice, lightTheme as light, lightColors, links as menuConfig, status as menuStatus, types as toastTypes, useCarousel, useMatchBreakpoints, useModal, useModalV2, useOnClickOutside, useTooltip };
