...
var ExpandableLabel = function (_a) {
    var onClick = _a.onClick, expanded = _a.expanded, children = _a.children;
    return (React.createElement(Button$2, { variant: "text", "aria-label": "Hide or show expandable content", onClick: onClick, endIcon: expanded ? (React.createElement(Icon$39, { color: "primary" })) : (React.createElement(Icon$3g, { color: "primary" })) }, children));
};
...
var StyledToast = styled(Box)(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  position: fixed;\n  right: auto;\n  left: 16px;\n  box-shadow: 0px -4px 11px rgba(0, 0, 0, 0.1),\n    0px 20px 36px -8px rgba(14, 14, 44, 0.32), 0px 1px 1px rgba(0, 0, 0, 0.16);\n  border-radius: 16px;\n\n  background: ", ";\n  padding: 16px 20px;\n\n  ", " {\n    transform: translate(-50%, 0);\n    left: 50%;\n  }\n"], ["\n  position: fixed;\n  right: auto;\n  left: 16px;\n  box-shadow: 0px -4px 11px rgba(0, 0, 0, 0.1),\n    0px 20px 36px -8px rgba(14, 14, 44, 0.32), 0px 1px 1px rgba(0, 0, 0, 0.16);\n  border-radius: 16px;\n\n  background: ", ";\n  padding: 16px 20px;\n\n  ", " {\n    transform: translate(-50%, 0);\n    left: 50%;\n  }\n"])), function (_a) {
    ...
    return type === coloredVariants.SUCCESS
...
var ColoredToastItem = function (_a) {
    ...
    return (React.createElement(CSSTransition, __assign({ timeout: 250, style: style }, props),
        React.createElement(StyledToast, { left: "50%", type: toast.type },
            React.createElement(Flex, { alignItems: "center" },
                React.createElement(IconComponent, { iconName: toast.type === coloredVariants.SUCCESS ? "Check" : "Warning", color: "white", width: "26px" }),
