...
var LogoSwitcher = function (_a) {
    ...
    if (isMobile || isMd) {
        return React.createElement(BswIcon, null);
    }
    else if (logoSubtitle) {
        return (React.createElement(Flex, null,
            React.createElement(BswIcon, null),
            React.createElement(Box, { ml: "8px" },
                React.createElement(ProjectNameIcon, null),
                React.createElement(BodyText, { mt: "-6px", textAlign: "left", scale: "size12" }, logoSubtitle))));
    }
    return React.createElement(LogoWithTextIcon, null);
};
