    ...
    return (React.createElement(StyledButton$1, { onClick: onClick },
        React.createElement(SvgDiag, { viewBox: "0 0 42 42" },
            ...
            React.createElement(Content, null,
                React.createElement(Icon$32, { width: "20px", color: "currentColor" })))));
};
...
var DefaultSeparator = React.createElement(Icon$3u, { color: "dark500", width: "20px" });
...
var Button = function (props) {
    ...
    var endIconElement = isLoading ? (React.createElement(Icon$1A, { color: "contrast" })) : (endIcon);
    if (isLoading) {
...
var ExpandableButton = function (_a) {
    ...
    return (React.createElement(IconButton, { "aria-label": "Hide or show expandable content", onClick: onClick },
        children,
        expanded ? (React.createElement(Icon$3q, { color: "invertedContrast" })) : (React.createElement(Icon$3x, { color: "invertedContrast" }))));
};
...
var ExpandableLabel = function (_a) {
    var onClick = _a.onClick, expanded = _a.expanded, children = _a.children;
    return (React.createElement(Button, { variant: "text", "aria-label": "Hide or show expandable content", onClick: onClick, endIcon: expanded ? (React.createElement(Icon$3q, { color: "primary" })) : (React.createElement(Icon$3x, { color: "primary" })) }, children));
};
...
var StyledArrow = styled(Icon$3x)(templateObject_6$a || (templateObject_6$a = __makeTemplateObject(["\n  transition: transform 0.4s ease-in-out;\n  transform: ", ";\n"], ["\n  transition: transform 0.4s ease-in-out;\n  transform: ", ";\n"])), function (_a) {
...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(Link, __assign({ external: true }, props),
        children,
        React.createElement(Icon$3j, { color: props.color ? props.color : "primary", width: "16px", ml: "4px" })));
};
...
var Pagination = function (_a) {
    ...
    return (React.createElement(PaginationWrap, { className: paginationClass, variant: variant },
        React.createElement(ReactPaginate, { previousLabel: React.createElement(Icon$3r, { color: variant === "light" ? "primary" : "white" }), nextLabel: React.createElement(Icon$3u, { color: variant === "light" ? "primary" : "white" }), forcePage: forcePage, breakLabel: "...", breakClassName: "break-me", pageCount: pageCount, marginPagesDisplayed: marginPagesDisplayed, pageRangeDisplayed: pageRangeDisplayed, onPageChange: handlePageClick, containerClassName: "pagination", activeClassName: "active" })));
};
...
var socialStyles = function (_a) {
    ...
    return ({
        ...
        telegram: {
            icon: React.createElement(Icon$s, { width: size, color: color }),
...
var StyledChevronIcon = styled(function (_a) {
    var props = __rest(_a, []);
    return (React.createElement(Icon$3x, __assign({}, props)));
...
var ModalCloseButton = function (_a) {
    ...
    return (React.createElement(IconButton, { variant: "text", onClick: onDismiss, scale: "sm", "aria-label": "Close the dialog" },
        React.createElement(Icon$32, { color: closeBtnColor || "dark600", width: "24px" })));
};
var ModalBackButton = function (_a) {
    ...
    return (React.createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
        React.createElement(Icon$3l, { color: closeBtnColor || "primary" })));
};
...
var ModalWithBackground = function (_a) {
    ...
    return (React.createElement(StyledModal, { backgroundTransparent: backgroundTransparent },
        !hideCloseButton && (React.createElement(StyledIconButton, { variant: "text", className: "closeModal", scale: "sm", onClick: onDismiss, "aria-label": "Close the dialog" },
            React.createElement(Icon$32, { width: "24px", color: backBtnColor !== null && backBtnColor !== void 0 ? backBtnColor : "card" }))),
...
var BSWPrice = function (_a) {
    ...
    return (React.createElement(Wrapper$7, null,
        React.createElement(Icon$c, { width: "38px", className: "logo" }),
...
var LogoSwitcher = function (_a) {
    ...
    if (isMobile || isMd) {
        return React.createElement(Icon$c, { width: "32px" });
    }
            ...
            React.createElement(Alert, { progress: progress, title: title, variant: alertTypeMap[type], onClick: handleRemove },
                React.createElement("div", null,
                    hash && (React.createElement(LinkWrapper, null,
                        ...
                        React.createElement(Icon$3j, { ml: "6px", width: "18px", height: "18px", color: "primary" }))),
...
export { Icon$T as AboutBSWOpacityIcon, Icon$U as AboutBSWSolidIcon, Alert, Icon$Z as AnalyticsOpacityIcon, Icon$_ as AnalyticsSolidIcon, Icon$3k as ArrowDownIcon, Icon$g as ArrowFiguredIcon, Icon$3l as ArrowLeftIcon, Icon$3n as ArrowRightIcon, Icon$3h as ArrowSkipLeftIcon, Icon$3i as ArrowSkipRightIcon, Icon$3j as ArrowUpForwardIcon, Icon$3m as ArrowUpIcon, Icon$25 as AuctionIcon, Icon$23 as AuctionOpacityIcon, Icon$24 as AuctionSolidIcon, Icon$G as AuditProtectionOpacityIcon, Icon$F as AuditProtectionSolidIcon, Icon$D as AuditSearchOpacityIcon, Icon$E as AuditSearchSolidIcon, Icon$1A as AutoRenewAnimateIcon, Icon$1D as AutoRenewIcon, Icon$1B as AutoRenewOpacityAnimateIcon, Icon$1E as AutoRenewOpacityIcon, Icon$1C as AutoRenewSolidAnimateIcon, Icon$1F as AutoRenewSolidIcon, Icon$h as AvalancheIcon, Icon$j as BSCIcon, Badge$1 as Badge, Badge as BadgeButton, GridLayout$1 as BaseLayout, BaseMenu, Icon$2u as BellOpacityIcon, Icon$2v as BellSolidIcon, Icon$1V as BlockIcon, Icon$1U as BlockOpacityIcon, Icon$1T as BlockSolidIcon, Icon$B as BlogOpacityIcon, Icon$C as BlogSolidIcon, BodyText, Icon$2b as BookIcon, Icon$29 as BookOpacityIcon, Icon$2a as BookSolidIcon, Box, Breadcrumbs, Icon$3A as BscBlackRoundIcon, Icon$c as BswIcon, Icon$1q as BurgerCloseIcon, Icon$1r as BurgerIcon, Button, ButtonMenu, ButtonMenuItem, variants$7 as ButtonVariants, Icon$2W as CalculateIcon, Icon$2Y as CalculateOpacityIcon, Icon$2X as CalculateSolidIcon, Icon$2V as CalendarIcon, Card, CardBody, CardFooter, CardHeader, Icon$2E as CardViewIcon, GridLayout as CardsLayout, CarouselButtonsTypes, CarouselHeader, CarouselNumbersBlock, Icon$V as CharityOpacityIcon, Icon$W as CharitySolidIcon, Icon$2A as CheckCircleIcon, Icon$2B as CheckIcon, Icon$2y as CheckOpacityIcon, Icon$2z as CheckSolidIcon, Checkbox, Icon$3y as ChevronDownCircleOpacityIcon, Icon$3z as ChevronDownCircleSolidIcon, Icon$3x as ChevronDownIcon, Icon$3e as ChevronDownTripleIcon, Icon$3s as ChevronLeftCircleOpacityIcon, Icon$3t as ChevronLeftCircleSolidIcon, Icon$3r as ChevronLeftIcon, Icon$3v as ChevronRightCircleOpacityIcon, Icon$3w as ChevronRightCircleSolidIcon, Icon$3u as ChevronRightIcon, Icon$3d as ChevronRightTripleIcon, Icon$3o as ChevronUpCircleOpacityIcon, Icon$3p as ChevronUpCircleSolidIcon, Icon$3g as ChevronUpDoubleIcon, Icon$3q as ChevronUpIcon, Icon$3f as ChevronUpTripleIcon, ClickableElementContainer, Icon$31 as CloseCircleIcon, Icon$30 as CloseCircleOpacityIcon, Icon$2$ as CloseCircleSolidIcon, Icon$32 as CloseIcon, Icon$m as CoinMarketCapIcon, ColoredToasts, Icon$a as ConflictIcon, Container$2 as Container, ContainerCarousel, Icon$2k as CopyIcon, Icon$2i as CopyOpacityIcon, Icon$2j as CopySolidIcon, Icon$k as DeBankIcon, DirectionButton, Icon$2 as DiscountOpacityIcon, Icon$3 as DiscountSolidIcon, Icon$H as DocsOpacityIcon, Icon$I as DocsSolidIcon, Dot$1 as Dot, Icon$3D as DownloadIcon, Icon$9 as DropIcon, Dropdown, DropdownMenuItemType, Icon$1L as EditIcon, Icon$1K as EditOpacityIcon, Icon$1J as EditSolidIcon, Icon$1j as ExchangeOpacityIcon, Icon$1k as ExchangeSolidIcon, ExpandableButton, ExpandableIcon, ExpandableLabel, Icon$1h as ExpertModeOpacityIcon, Icon$1i as ExpertModeSolidIcon, Icon$2C as EyeCloseIcon, Icon$2D as EyeOpenIcon, Icon$o as FacebookIcon, Faqs, Icon$1d as FarmsOpacityIcon, Icon$1e as FarmsSolidIcon, Icon$2H as FavoriteEmptyIcon, Icon$2G as FavoriteSolidIcon, Icon$28 as FileIcon, Icon$26 as FileOpacityIcon, Icon$27 as FileSolidIcon, Icon$2e as FilterIcon, Icon$2c as FilterOpacityIcon, Icon$2d as FilterSolidIcon, Icon$2R as FireIcon, Icon$2P as FireOpacityIcon, Icon$2Q as FireSolidIcon, Icon$$ as FixedStakingOpacityIcon, Icon$10 as FixedStakingSolidIcon, Icon$1Y as FlagIcon, Icon$1X as FlagOpacityIcon, Icon$1W as FlagSolidIcon, Flex, Icon$1H as GasIcon, Icon$5 as GiftIcon, Icon$17 as GobletOpacityIcon, Icon$18 as GobletSolidIcon, Grid, HeadText, Heading, Icon$2S as HelpIcon, Icon$2U as HelpOpacityIcon, Icon$2T as HelpSolidIcon, HeroWrapper, Icon$1u as HistoryIcon, Icon$3B as HourglassIcon, IconButton, IconComponent, Icon$19 as IdoOpacityIcon, Icon$1a as IdoSolidIcon, Image, Icon$2O as InfoIcon, Icon$2M as InfoOpacityIcon, Icon$2N as InfoSolidIcon, InlineMenu, InlineMenuContainer, Input$1 as Input, InputGroup, Icon$v as InstagramIcon, ItemTypes, Icon$6 as LanguageIcon, Icon$13 as LaunchpadOpacityIcon, Icon$14 as LaunchpadSolidIcon, Icon$b as LightningIcon, Icon$z as LimitOrderOpacityIcon, Icon$A as LimitOrderSolidIcon, Link, LinkExternal, Icon$1l as LiquidityOpacityIcon, Icon$1m as LiquiditySolidIcon, Icon$y as LiquidityStakingOpacityIcon, Icon$x as LiquidityStakingSolidIcon, Icon$w as LiquidityStakingSolidOpacityIcon, Icon$1w as ListOpacityIcon, Icon$1v as ListSolidIcon, Icon$2F as ListViewIcon, Icon$8 as LockIcon, Icon$e as LogoWithTextIcon, Icon$15 as LotteryOpacityIcon, Icon$16 as LotterySolidIcon, MatchBreakpointsProvider, Icon$1I as MedalIcon, Icon$u as MediumIcon, Menu, Icon$37 as MinusCircleOpacityIcon, Icon$38 as MinusCircleSolidIcon, Icon$39 as MinusIcon, Modal, ModalBackButton, ModalBody$1 as ModalBody, ModalCloseButton, ModalContainer, ModalProvider, ModalTitle, ModalV2, ModalV2Context, ModalWithBackground, ModalWrapper, Icon$1M as More2Icon, Icon$1P as MoreHorizontalIcon, Icon$1N as MoreHorizontalOpacityIcon, Icon$1O as MoreHorizontalSolidIcon, Icon$1S as MoreVerticalIcon, Icon$1Q as MoreVerticalOpacityIcon, Icon$1R as MoreVerticalSolidIcon, Icon$3C as MouseIcon, Icon$M as MultiPoolOpacityIcon, Icon$L as MultiPoolSolidIcon, Icon$11 as NFTEarnOpacityIcon, Icon$12 as NFTEarnSolidIcon, Icon$J as NewsOpacityIcon, Icon$K as NewsSolidIcon, NotificationDot, Icon$2n as OptionsOpacityIcon, Icon$2o as OptionsSolidIcon, Overlay, Pagination, PercentSlider, Icon$1 as PerpetualOpacityIcon, Icon as PerpetualSolidIcon, Icon$1G as PlayIcon, Icon$3a as PlusCircleOpacityIcon, Icon$3b as PlusCircleSolidIcon, Icon$3c as PlusIcon, Icon$i as PolygonIcon, Icon$1f as PoolsOpacityIcon, Icon$1g as PoolsSolidIcon, Icon$1s as ProductsOpacityIcon, Icon$1t as ProductsSolidIcon, Icon$P as Program10mOpacityIcon, Icon$Q as Program10mSolidIcon, Icon$d as ProjectNameIcon, Icon$l as QuoraIcon, Radio, Icon$t as RedditIcon, Icon$1b as ReferralOpacityIcon, Icon$1c as ReferralSolidIcon, Icon$1z as RefreshIcon, Icon$1y as RefreshOpacityIcon, Icon$1x as RefreshSolidIcon, ResetCSS, Icon$4 as RouteIcon, Icon$2s as SearchOpacityIcon, Icon$2t as SearchSolidIcon, Icon$2h as ShareIcon, Icon$2f as ShareOpacityIcon, Icon$2g as ShareSolidIcon, Skeleton, Slider, SocialShareButton, SocialShareButtonCircle, Icon$N as SpaceAgentOpacityIcon, Icon$O as SpaceAgentSolidIcon, Icon$2r as StarIcon, Icon$2q as StarOpacityIcon, Icon$2p as StarSolidIcon, SubMenu, SubMenuContainer, SubMenuItem, SubMenuItems, Svg, Icon$2L as SwapHorizontalOpacityIcon, Icon$2K as SwapHorizontalSolidIcon, Icon$2J as SwapVerticalOpacityIcon, Icon$2I as SwapVerticalSolidIcon, TabMenu, TabBarItem as TabMenuItem, TableCardSkeleton, Icon$R as TeamOpacityIcon, Icon$S as TeamSolidIcon, Icon$s as TelegramIcon, Terms, Icon$1$ as TestIcon, Icon$1_ as TestOpacityIcon, Icon$1Z as TestSolidIcon, Text, Icon$f as Ticket2Icon, Icon$n as TikTokIcon, Icon$22 as TimerIcon, Icon$20 as TimerOpacityIcon, Icon$21 as TimerSolidIcon, ToastContainer, Toggle, TooltipHelper, TooltipText, Icon$r as TwitchIcon, Icon$q as TwitterIcon, Icon$7 as UnlockIcon, Icon$1n as UsdLineIcon, Icon$1p as UsdOpacityIcon, Icon$1o as UsdSolidIcon, Icon$2w as UserOpacityIcon, Icon$2x as UserSolidIcon, Icon$2l as VerifiedOpacityIcon, Icon$2m as VerifiedSolidIcon, ViewMode, Icon$X as VotingOpacityIcon, Icon$Y as VotingSolidIcon, Icon$2Z as WalletOpacityIcon, Icon$2_ as WalletSolidIcon, Icon$33 as WarningCycleIcon, Icon$34 as WarningIcon, Icon$36 as WarningOpacityIcon, Icon$35 as WarningSolidIcon, Icon$p as YoutubeIcon, variants$8 as alertVariants, bodyTextScaleMap, coloredVariants, darkTheme as dark, darkColors, formatSpacingAmount, getExternalLinkProps, getPortalRoot, getResponsiveAttrs, getRgba, getThemeValue, headTextScaleMap, isTouchDevice, lightTheme as light, lightColors, links as menuConfig, status as menuStatus, types as toastTypes, useCarousel, useMatchBreakpoints, useModal, useModalV2, useOnClickOutside, useTooltip };
