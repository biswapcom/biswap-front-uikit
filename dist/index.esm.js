...
var Icon$o = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24", fill: "currentColor" }, props),
        React.createElement("path", { d: "M18.244 2.25H21.552L14.325 10.51L22.827 21.75H16.17L10.956 14.933L4.99 21.75H1.68L9.41 12.915L1.254 2.25H8.08L12.793 8.481L18.244 2.25ZM17.083 19.77H18.916L7.084 4.126H5.117L17.083 19.77Z", fill: "#556E9A" })));
};
    ...
    return (React.createElement(StyledButton$1, { onClick: onClick },
        React.createElement(SvgDiag, { viewBox: "0 0 42 42" },
            ...
            React.createElement(Content, null,
                React.createElement(Icon$30, { width: "20px", color: "currentColor" })))));
};
...
var DefaultSeparator = React.createElement(Icon$3s, { color: "dark500", width: "20px" });
...
var Button = function (props) {
    ...
    var endIconElement = isLoading ? (React.createElement(Icon$1y, { color: "contrast" })) : (endIcon);
    if (isLoading) {
...
var ExpandableButton = function (_a) {
    ...
    return (React.createElement(IconButton, { "aria-label": "Hide or show expandable content", onClick: onClick },
        children,
        expanded ? (React.createElement(Icon$3o, { color: "invertedContrast" })) : (React.createElement(Icon$3v, { color: "invertedContrast" }))));
};
...
var ExpandableLabel = function (_a) {
    var onClick = _a.onClick, expanded = _a.expanded, children = _a.children;
    return (React.createElement(Button, { variant: "text", "aria-label": "Hide or show expandable content", onClick: onClick, endIcon: expanded ? (React.createElement(Icon$3o, { color: "primary" })) : (React.createElement(Icon$3v, { color: "primary" })) }, children));
};
        ...
        React.createElement(Flex, { position: "relative", justifyContent: title ? "space-between" : "flex-end", mb: isMobile ? "24px" : "32px", alignItems: isMobile ? "flex-end" : "flex-start" },
            ...
            showNavButtons && (React.createElement(Flex, { ml: "8px" },
                ...
                React.createElement(NavButton, { scale: "xs", variant: "primary", ml: "8px", onClick: function () {
                    ...
                    React.createElement(Icon$3s, { color: "white" })))))));
};
...
var StyledArrow = styled(Icon$3v)(templateObject_6$a || (templateObject_6$a = __makeTemplateObject(["\n  transition: transform 0.4s ease-in-out;\n  transform: ", ";\n"], ["\n  transition: transform 0.4s ease-in-out;\n  transform: ", ";\n"])), function (_a) {
...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(Link, __assign({ external: true }, props),
        children,
        React.createElement(Icon$3h, { color: props.color ? props.color : "primary", width: "16px", ml: "4px" })));
};
...
var StyledChevronIcon = styled(function (_a) {
    var props = __rest(_a, []);
    return (React.createElement(Icon$3v, __assign({}, props)));
...
var ModalCloseButton = function (_a) {
    ...
    return (React.createElement(IconButton, { variant: "text", onClick: onDismiss, scale: "sm", "aria-label": "Close the dialog" },
        React.createElement(Icon$30, { color: closeBtnColor || "dark600", width: "24px" })));
};
var ModalBackButton = function (_a) {
    ...
    return (React.createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
        React.createElement(Icon$3j, { color: closeBtnColor || "primary" })));
};
...
var ModalWithBackground = function (_a) {
    ...
    return (React.createElement(StyledModal, { backgroundTransparent: backgroundTransparent },
        !hideCloseButton && (React.createElement(StyledIconButton, { variant: "text", className: "closeModal", scale: "sm", onClick: onDismiss, "aria-label": "Close the dialog" },
            React.createElement(Icon$30, { width: "24px", color: backBtnColor !== null && backBtnColor !== void 0 ? backBtnColor : "card" }))),
            ...
            React.createElement(Alert, { progress: progress, title: title, variant: alertTypeMap[type], onClick: handleRemove },
                React.createElement("div", null,
                    hash && (React.createElement(LinkWrapper, null,
                        ...
                        React.createElement(Icon$3h, { ml: "6px", width: "18px", height: "18px", color: "primary" }))),
...
export { Icon$R as AboutBSWOpacityIcon, Icon$S as AboutBSWSolidIcon, Alert, Icon$X as AnalyticsOpacityIcon, Icon$Y as AnalyticsSolidIcon, Icon$3i as ArrowDownIcon, Icon$e as ArrowFiguredIcon, Icon$3j as ArrowLeftIcon, Icon$3l as ArrowRightIcon, Icon$3f as ArrowSkipLeftIcon, Icon$3g as ArrowSkipRightIcon, Icon$3h as ArrowUpForwardIcon, Icon$3k as ArrowUpIcon, Icon$23 as AuctionIcon, Icon$21 as AuctionOpacityIcon, Icon$22 as AuctionSolidIcon, Icon$E as AuditProtectionOpacityIcon, Icon$D as AuditProtectionSolidIcon, Icon$B as AuditSearchOpacityIcon, Icon$C as AuditSearchSolidIcon, Icon$1y as AutoRenewAnimateIcon, Icon$1B as AutoRenewIcon, Icon$1z as AutoRenewOpacityAnimateIcon, Icon$1C as AutoRenewOpacityIcon, Icon$1A as AutoRenewSolidAnimateIcon, Icon$1D as AutoRenewSolidIcon, Icon$f as AvalancheIcon, Icon$h as BSCIcon, Badge$1 as Badge, Badge as BadgeButton, GridLayout$1 as BaseLayout, BaseMenu, Icon$2s as BellOpacityIcon, Icon$2t as BellSolidIcon, Icon$1T as BlockIcon, Icon$1S as BlockOpacityIcon, Icon$1R as BlockSolidIcon, Icon$z as BlogOpacityIcon, Icon$A as BlogSolidIcon, BodyText, Icon$29 as BookIcon, Icon$27 as BookOpacityIcon, Icon$28 as BookSolidIcon, Box, Breadcrumbs, Icon$3y as BscBlackRoundIcon, Icon$a as BswIcon, Icon$1o as BurgerCloseIcon, Icon$1p as BurgerIcon, Button, ButtonMenu, ButtonMenuItem, Icon$2U as CalculateIcon, Icon$2W as CalculateOpacityIcon, Icon$2V as CalculateSolidIcon, Icon$2T as CalendarIcon, Card, CardBody, CardFooter, CardHeader, Icon$2C as CardViewIcon, GridLayout as CardsLayout, CarouselButtonsTypes, CarouselHeader, CarouselNumbersBlock, Icon$T as CharityOpacityIcon, Icon$U as CharitySolidIcon, Icon$2y as CheckCircleIcon, Icon$2z as CheckIcon, Icon$2w as CheckOpacityIcon, Icon$2x as CheckSolidIcon, Checkbox, Icon$3w as ChevronDownCircleOpacityIcon, Icon$3x as ChevronDownCircleSolidIcon, Icon$3v as ChevronDownIcon, Icon$3c as ChevronDownTripleIcon, Icon$3q as ChevronLeftCircleOpacityIcon, Icon$3r as ChevronLeftCircleSolidIcon, Icon$3p as ChevronLeftIcon, Icon$3t as ChevronRightCircleOpacityIcon, Icon$3u as ChevronRightCircleSolidIcon, Icon$3s as ChevronRightIcon, Icon$3b as ChevronRightTripleIcon, Icon$3m as ChevronUpCircleOpacityIcon, Icon$3n as ChevronUpCircleSolidIcon, Icon$3e as ChevronUpDoubleIcon, Icon$3o as ChevronUpIcon, Icon$3d as ChevronUpTripleIcon, ClickableElementContainer, Icon$2$ as CloseCircleIcon, Icon$2_ as CloseCircleOpacityIcon, Icon$2Z as CloseCircleSolidIcon, Icon$30 as CloseIcon, Icon$k as CoinMarketCapIcon, ColoredToasts, Container$2 as Container, ContainerCarousel, Icon$2i as CopyIcon, Icon$2g as CopyOpacityIcon, Icon$2h as CopySolidIcon, Icon$i as DeBankIcon, DirectionButton, Icon$2 as DiscountOpacityIcon, Icon$3 as DiscountSolidIcon, Icon$F as DocsOpacityIcon, Icon$G as DocsSolidIcon, Dot$1 as Dot, Icon$3B as DownloadIcon, Dropdown, DropdownMenuItemType, Icon$1J as EditIcon, Icon$1I as EditOpacityIcon, Icon$1H as EditSolidIcon, Icon$1h as ExchangeOpacityIcon, Icon$1i as ExchangeSolidIcon, ExpandableButton, ExpandableIcon, ExpandableLabel, Icon$1f as ExpertModeOpacityIcon, Icon$1g as ExpertModeSolidIcon, Icon$2A as EyeCloseIcon, Icon$2B as EyeOpenIcon, Icon$m as FacebookIcon, Faqs, Icon$1b as FarmsOpacityIcon, Icon$1c as FarmsSolidIcon, Icon$2F as FavoriteEmptyIcon, Icon$2E as FavoriteSolidIcon, Icon$26 as FileIcon, Icon$24 as FileOpacityIcon, Icon$25 as FileSolidIcon, Icon$2c as FilterIcon, Icon$2a as FilterOpacityIcon, Icon$2b as FilterSolidIcon, Icon$2P as FireIcon, Icon$2N as FireOpacityIcon, Icon$2O as FireSolidIcon, Icon$Z as FixedStakingOpacityIcon, Icon$_ as FixedStakingSolidIcon, Icon$1W as FlagIcon, Icon$1V as FlagOpacityIcon, Icon$1U as FlagSolidIcon, Flex, Icon$1F as GasIcon, Icon$5 as GiftIcon, Icon$15 as GobletOpacityIcon, Icon$16 as GobletSolidIcon, Grid, HeadText, Heading, Icon$2Q as HelpIcon, Icon$2S as HelpOpacityIcon, Icon$2R as HelpSolidIcon, HeroWrapper, Icon$1s as HistoryIcon, Icon$3z as HourglassIcon, IconButton, IconComponent, Icon$17 as IdoOpacityIcon, Icon$18 as IdoSolidIcon, Image, Icon$2M as InfoIcon, Icon$2K as InfoOpacityIcon, Icon$2L as InfoSolidIcon, InlineMenu, InlineMenuContainer, Input$1 as Input, InputGroup, Icon$t as InstagramIcon, ItemTypes, Icon$6 as LanguageIcon, Icon$11 as LaunchpadOpacityIcon, Icon$12 as LaunchpadSolidIcon, Icon$9 as LightningIcon, Icon$x as LimitOrderOpacityIcon, Icon$y as LimitOrderSolidIcon, Link, LinkExternal, Icon$1j as LiquidityOpacityIcon, Icon$1k as LiquiditySolidIcon, Icon$w as LiquidityStakingOpacityIcon, Icon$v as LiquidityStakingSolidIcon, Icon$u as LiquidityStakingSolidOpacityIcon, Icon$1u as ListOpacityIcon, Icon$1t as ListSolidIcon, Icon$2D as ListViewIcon, Icon$8 as LockIcon, Icon$c as LogoWithTextIcon, Icon$13 as LotteryOpacityIcon, Icon$14 as LotterySolidIcon, MatchBreakpointsProvider, Icon$1G as MedalIcon, Icon$s as MediumIcon, Menu, Icon$35 as MinusCircleOpacityIcon, Icon$36 as MinusCircleSolidIcon, Icon$37 as MinusIcon, Modal, ModalBackButton, ModalBody$1 as ModalBody, ModalCloseButton, ModalContainer, ModalHeader, ModalProvider, ModalTitle, ModalV2, ModalV2Context, ModalWithBackground, ModalWrapper, Icon$1K as More2Icon, Icon$1N as MoreHorizontalIcon, Icon$1L as MoreHorizontalOpacityIcon, Icon$1M as MoreHorizontalSolidIcon, Icon$1Q as MoreVerticalIcon, Icon$1O as MoreVerticalOpacityIcon, Icon$1P as MoreVerticalSolidIcon, Icon$3A as MouseIcon, Icon$K as MultiPoolOpacityIcon, Icon$J as MultiPoolSolidIcon, Icon$$ as NFTEarnOpacityIcon, Icon$10 as NFTEarnSolidIcon, Icon$H as NewsOpacityIcon, Icon$I as NewsSolidIcon, NotificationDot, Icon$2l as OptionsOpacityIcon, Icon$2m as OptionsSolidIcon, Overlay, Pagination, PercentSlider, Icon$1 as PerpetualOpacityIcon, Icon as PerpetualSolidIcon, Icon$1E as PlayIcon, Icon$38 as PlusCircleOpacityIcon, Icon$39 as PlusCircleSolidIcon, Icon$3a as PlusIcon, Icon$g as PolygonIcon, Icon$1d as PoolsOpacityIcon, Icon$1e as PoolsSolidIcon, Icon$1q as ProductsOpacityIcon, Icon$1r as ProductsSolidIcon, Icon$N as Program10mOpacityIcon, Icon$O as Program10mSolidIcon, Icon$b as ProjectNameIcon, Icon$j as QuoraIcon, Radio, Icon$r as RedditIcon, Icon$19 as ReferralOpacityIcon, Icon$1a as ReferralSolidIcon, Icon$1x as RefreshIcon, Icon$1w as RefreshOpacityIcon, Icon$1v as RefreshSolidIcon, ResetCSS, Icon$4 as RouteIcon, Icon$2q as SearchOpacityIcon, Icon$2r as SearchSolidIcon, Icon$2f as ShareIcon, Icon$2d as ShareOpacityIcon, Icon$2e as ShareSolidIcon, Skeleton, Slider, SocialShareButton, SocialShareButtonCircle, Icon$L as SpaceAgentOpacityIcon, Icon$M as SpaceAgentSolidIcon, Icon$2p as StarIcon, Icon$2o as StarOpacityIcon, Icon$2n as StarSolidIcon, SubMenu, SubMenuContainer, SubMenuItem, SubMenuItems, Svg, Icon$2J as SwapHorizontalOpacityIcon, Icon$2I as SwapHorizontalSolidIcon, Icon$2H as SwapVerticalOpacityIcon, Icon$2G as SwapVerticalSolidIcon, TabMenu, TabBarItem as TabMenuItem, TableCardSkeleton, Icon$P as TeamOpacityIcon, Icon$Q as TeamSolidIcon, Icon$q as TelegramIcon, Terms, Icon$1Z as TestIcon, Icon$1Y as TestOpacityIcon, Icon$1X as TestSolidIcon, Text, Icon$d as Ticket2Icon, Icon$l as TikTokIcon, Icon$20 as TimerIcon, Icon$1_ as TimerOpacityIcon, Icon$1$ as TimerSolidIcon, ToastContainer, Toggle, TooltipHelper, TooltipText, Icon$p as TwitchIcon, Icon$o as TwitterIcon, Icon$7 as UnlockIcon, Icon$1l as UsdLineIcon, Icon$1n as UsdOpacityIcon, Icon$1m as UsdSolidIcon, Icon$2u as UserOpacityIcon, Icon$2v as UserSolidIcon, Icon$2j as VerifiedOpacityIcon, Icon$2k as VerifiedSolidIcon, ViewMode, Icon$V as VotingOpacityIcon, Icon$W as VotingSolidIcon, Icon$2X as WalletOpacityIcon, Icon$2Y as WalletSolidIcon, Icon$31 as WarningCycleIcon, Icon$32 as WarningIcon, Icon$34 as WarningOpacityIcon, Icon$33 as WarningSolidIcon, Icon$n as YoutubeIcon, variants$8 as alertVariants, bodyTextScaleMap, coloredVariants, darkTheme as dark, darkColors, formatSpacingAmount, getExternalLinkProps, getPortalRoot, getResponsiveAttrs, getRgba, getThemeValue, headTextScaleMap, isTouchDevice, lightTheme as light, lightColors, links as menuConfig, status as menuStatus, types as toastTypes, useCarousel, useMatchBreakpoints, useModal, useModalV2, useOnClickOutside, useTooltip };
