...
const Button = (props) => {
    ...
    const endIconElement = isLoading ? (React__default["default"].createElement(Icon$1D, { color: "contrast" })) : (endIcon);
    if (isLoading) {
...
const QuestionWrapper = styled__default["default"](Flex) `
  ...
  ${({ showTooltip }) => showTooltip &&
    ...
    `}
`;
const TooltipHelper = ({ text, placement = "auto", size = "16px", color = "pastelBlue", trigger, Icon = Icon$2V, ml = "4px", children, showTooltip = true, ...props }) => {
