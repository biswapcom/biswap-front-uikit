...
`;
const Svg = styled__default["default"].svg.attrs(({ width = "20px", xmlns = "http://www.w3.org/2000/svg", ...props }) => ({
    width,
    xmlns,
    ...props,
})) `
  align-self: center; // Safari fix
  fill: ${({ theme, color = "gray900" }) => getThemeValue(`colors.${color}`, color)(theme)};
  flex-shrink: 0;
  ${({ spin }) => spin && spinStyle}
  ${styledSystem.space}
`;
...
var IconModule = /*#__PURE__*/Object.freeze({
  ...
  ChevronRightCircleOpacityIcon: Icon$3z,
  ChevronRightIcon: Icon$3y,
  ChevronLeftCircleSolidIcon: Icon$3x,
  ChevronLeftCircleOpacityIcon: Icon$3w,
  ChevronLeftIcon: Icon$3v,
  ChevronUpIcon: Icon$3u,
  ChevronUpCircleSolidIcon: Icon$3t,
  ChevronUpCircleOpacityIcon: Icon$3s,
  ArrowRightIcon: Icon$3r,
  ArrowUpIcon: Icon$3q,
  ArrowLeftIcon: Icon$3p,
  ArrowDownIcon: Icon$3o,
  ArrowUpForwardIcon: Icon$3n,
  ArrowSkipRightIcon: Icon$3m,
  ArrowSkipLeftIcon: Icon$3l,
  ChevronUpDoubleIcon: Icon$3k,
  ChevronUpTripleIcon: Icon$3j,
  ChevronDownTripleIcon: Icon$3i,
  ChevronRightTripleIcon: Icon$3h,
  PlusIcon: Icon$3g,
  PlusCircleSolidIcon: Icon$3f,
  PlusCircleOpacityIcon: Icon$3e,
  MinusIcon: Icon$3d,
  MinusCircleSolidIcon: Icon$3c,
  MinusCircleOpacityIcon: Icon$3b,
  WarningOpacityIcon: Icon$3a,
  WarningSolidIcon: Icon$39,
  WarningIcon: Icon$38,
  WarningCycleIcon: Icon$37,
  CloseIcon: Icon$36,
  CloseCircleIcon: Icon$35,
  CloseCircleOpacityIcon: Icon$34,
  CloseCircleSolidIcon: Icon$33,
  WalletSolidIcon: Icon$32,
  WalletOpacityIcon: Icon$31,
  CalculateOpacityIcon: Icon$30,
  CalculateSolidIcon: Icon$2$,
  CalculateIcon: Icon$2_,
  CalendarIcon: Icon$2Z,
  HelpOpacityIcon: Icon$2Y,
  HelpSolidIcon: Icon$2X,
  HelpIcon: Icon$2W,
  FireIcon: Icon$2V,
  FireSolidIcon: Icon$2U,
  FireOpacityIcon: Icon$2T,
  InfoIcon: Icon$2S,
  InfoSolidIcon: Icon$2R,
  InfoOpacityIcon: Icon$2Q,
  SwapHorizontalOpacityIcon: Icon$2P,
  SwapHorizontalSolidIcon: Icon$2O,
  SwapVerticalOpacityIcon: Icon$2N,
  SwapVerticalSolidIcon: Icon$2M,
  FavoriteEmptyIcon: Icon$2L,
  FavoriteSolidIcon: Icon$2K,
  ListViewIcon: Icon$2J,
  CardViewIcon: Icon$2I,
  EyeOpenIcon: Icon$2H,
  EyeCloseIcon: Icon$2G,
  CheckIcon: Icon$2F,
  CheckCircleIcon: Icon$2E,
  CheckSolidIcon: Icon$2D,
  CheckOpacityIcon: Icon$2C,
  UserSolidIcon: Icon$2B,
  UserOpacityIcon: Icon$2A,
  BellSolidIcon: Icon$2z,
  BellOpacityIcon: Icon$2y,
  SearchSolidIcon: Icon$2x,
  SearchOpacityIcon: Icon$2w,
  StarIcon: Icon$2v,
  StarOpacityIcon: Icon$2u,
  StarSolidIcon: Icon$2t,
  OptionsSolidIcon: Icon$2s,
  OptionsOpacityIcon: Icon$2r,
  VerifiedSolidIcon: Icon$2q,
  VerifiedOpacityIcon: Icon$2p,
  CopyIcon: Icon$2o,
  CopySolidIcon: Icon$2n,
  CopyOpacityIcon: Icon$2m,
  ShareIcon: Icon$2l,
  ShareSolidIcon: Icon$2k,
  ShareOpacityIcon: Icon$2j,
  FilterIcon: Icon$2i,
  FilterSolidIcon: Icon$2h,
  FilterOpacityIcon: Icon$2g,
  BookIcon: Icon$2f,
  BookSolidIcon: Icon$2e,
  BookOpacityIcon: Icon$2d,
  FileIcon: Icon$2c,
  FileSolidIcon: Icon$2b,
  FileOpacityIcon: Icon$2a,
  AuctionIcon: Icon$29,
  AuctionSolidIcon: Icon$28,
  AuctionOpacityIcon: Icon$27,
  TimerIcon: Icon$26,
  TimerSolidIcon: Icon$25,
  TimerOpacityIcon: Icon$24,
  TestIcon: Icon$23,
  TestOpacityIcon: Icon$22,
  TestSolidIcon: Icon$21,
  FlagIcon: Icon$20,
  FlagOpacityIcon: Icon$1$,
  FlagSolidIcon: Icon$1_,
  BlockIcon: Icon$1Z,
  BlockOpacityIcon: Icon$1Y,
  BlockSolidIcon: Icon$1X,
  MoreVerticalIcon: Icon$1W,
  MoreVerticalSolidIcon: Icon$1V,
  MoreVerticalOpacityIcon: Icon$1U,
  MoreHorizontalIcon: Icon$1T,
  MoreHorizontalSolidIcon: Icon$1S,
  MoreHorizontalOpacityIcon: Icon$1R,
  More2Icon: Icon$1Q,
  EditIcon: Icon$1P,
    ...
    return (React__default["default"].createElement(StyledButton$1, { onClick: onClick },
        React__default["default"].createElement(SvgDiag, { viewBox: "0 0 42 42" },
            ...
            React__default["default"].createElement(Content, null,
                React__default["default"].createElement(Icon$36, { width: "20px", color: "currentColor" })))));
};

const getThemeColor = ({ variant = variants$8.INFO }) => {
    switch (variant) {
...
const getIcon = (variant = variants$8.INFO) => {
    switch (variant) {
        case variants$8.DANGER:
            return Icon$33;
        case variants$8.WARNING:
...
const getIconColor = (variant = variants$8.INFO) => {
    switch (variant) {
        case variants$8.DANGER:
            return "secondary";
        case variants$8.WARNING:
...
const DefaultSeparator = React__default["default"].createElement(Icon$3y, { color: "dark500", width: "20px" });
...
const Bubble = styled__default["default"].span `
  ...
  &:before {
    ...
    left: -2px;
    z-index: 1;
    animation: ${({ color }) => color ? PULSES$1[color.toUpperCase()] : PULSE_SUCCESS$1}
      2s infinite;
  }
`;
const Button = (props) => {
    const { addBubble, bubbleColor, startIcon, endIcon, external = false, className, isLoading = false, disabled = false, children, loadingTitle, variant = variants$7.PRIMARY, scale = scales$a.MD, ...rest } = props;
...
const ExpandableButton = ({ onClick, expanded = false, children, }) => {
    return (React__default["default"].createElement(IconButton, { "aria-label": "Hide or show expandable content", onClick: onClick },
        children,
        expanded ? (React__default["default"].createElement(Icon$3u, { color: "invertedContrast" })) : (React__default["default"].createElement(Icon$3B, { color: "invertedContrast" }))));
};
const ExpandableLabel = ({ onClick, expanded = false, children, }) => {
    return (React__default["default"].createElement(Button, { variant: "text", "aria-label": "Hide or show expandable content", onClick: onClick, endIcon: expanded ? (React__default["default"].createElement(Icon$3u, { color: "primary" })) : (React__default["default"].createElement(Icon$3B, { color: "primary" })) }, children));
};
...
`;
const Selection$1 = styled__default["default"].div `
  background-color: ${({ theme, variant }) => theme.colors[variant === variants$6.DARK
    ? "dark500"
  ...
  border-radius: ${({ scale }) => (scale === scales$9.SM ? "6px" : "8px")};
  ...
  ${({ flatTop, scale }) => flatTop &&
    styled.css `
      border-radius: ${scale === scales$9.SM ? "0 0 6px 6px" : "0 0 8px 8px"};
      height: calc(100% - 4px);
      top: calc(50% - 2px);
    `}
  ...
  ${({ flatBottom, scale }) => flatBottom &&
    styled.css `
      border-radius: ${scale === scales$9.SM ? "6px 6px 0 0" : "8px 8px 0 0"};
      height: calc(100% - 4px);
      top: calc(50% + 2px);
    `}

  ${({ theme, variant }) => variant === variants$6.DARK &&
    `box-shadow: 0 2px 4px ${getRgba(theme.colors.backgroundDark, theme, 0.08)}`};
`;
const ButtonMenu = ({ activeIndex = 0, scale = scales$9.MD, variant = variants$6.DARK, onItemClick, disabled, children, fullWidth = false, flatBottom = false, flatTop = false, withoutBackground = false, scrollX = false, equalElementWidth, withoutAnimation = false, itemsProperties = [], ...props }) => {
...
const Marker = styled__default["default"](Box) `
  ...
  &:before {
    ...
    left: -2px;
    z-index: 1;
    animation: ${({ color }) => color ? PULSES[color.toUpperCase()] : PULSE_SUCCESS}
      2s infinite;
  }
`;
...
const getPortalRoot = () => typeof window !== "undefined" &&
...
const useTooltip = (content, options) => {
    ...
    const { placement = "auto", trigger = isMobile || isTablet ? "click" : "hover", tooltipPadding = { left: 16, right: 16 }, tooltipOffset = [0, 10], disableStopPropagation, openedByDefault = false, } = options;
    ...
    const tooltip = (React__default["default"].createElement(StyledTooltip, { ref: setTooltipElement, style: styles.popper, ...attributes.popper },
...
const HeadText = styled__default["default"](Text).attrs({
    bold: true,
    as: tags$1.H2,
}) `
  font-size: ${({ scale }) => headTextScaleMap[scale || scales$8.SIZE32].fontSize};
  line-height: ${({ scale }) => headTextScaleMap[scale || scales$8.SIZE32].lineHeight};
  font-weight: 600;
...
const getScalesAttributes = ({ scale, as }) => {
    ...
    return {
        fontSize: breakpointsKeys.map((breakPoint) => tempScales[breakPoint]
            ? bodyTextScaleMap[tempScales[breakPoint]].fontSize
            : null),
        lineHeight: breakpointsKeys.map((breakPoint) => tempScales[breakPoint]
...
const Container$2 = ({ children, ...props }) => (React__default["default"].createElement(Box, { width: "100%", px: getResponsiveAttrs({ xs: "16px", lg: "24px", xxl: 0 }), mx: "auto", maxWidth: "1120px", ...props }, children));

const HeroWrapper = ({ children, ...props }) => {
    return (React__default["default"].createElement(Box, { p: getResponsiveAttrs({ xs: "96px 0 0", md: "104px 0 0" }), width: "100%", ...props }, children));
};

const ContainerCarousel = ({ children, ...props }) => (React__default["default"].createElement(Box, { px: getResponsiveAttrs({ xs: 0, sm: 0, md: "16px", lg: "24px", xxl: 0 }), mx: "auto", maxWidth: "1120px", ...props }, children));
    ...
    return (React__default["default"].createElement(Container$2, null,
        React__default["default"].createElement(Flex, { position: "relative", justifyContent: title ? "space-between" : "flex-end", mb: isMobile ? "24px" : "32px", alignItems: isMobile ? "flex-end" : "flex-start" },
            ...
            showNavButtons && (React__default["default"].createElement(Flex, { ml: "8px" },
                React__default["default"].createElement(NavButton, { scale: "xs", variant: "primary", onClick: () => {
                        handleNav("prev");
                    } },
                    React__default["default"].createElement(Icon$3v, { color: "white" })),
                React__default["default"].createElement(NavButton, { scale: "xs", variant: "primary", ml: "8px", onClick: () => {
                        handleNav("next");
                    } },
                    React__default["default"].createElement(Icon$3y, { color: "white" })))))));
};
...
const Viewport = styled__default["default"].div `
  ...
  width: 100%;
`;
const Container$1 = styled__default["default"](Flex) `
  user-select: none;
...
const MenuItemButton = styled__default["default"].button `
  ...
  ${({ isActive, colorKey, hoverKey }) => !isActive &&
    ...
    `}
`;
const ButtonMenuItem = ({ isActive = false, variant = variants$6.DARK, properties, scale = scales$9.MD, as, setWidth, itemIndex = 0, activeButtonIndex, blockOffset, onItemClick = () => { }, onClick = () => { }, ...props }) => {
    ...
    const { targetRef, tooltip, tooltipVisible } = useTooltip(properties?.tooltipText, { placement: "top", disableStopPropagation });
...
`;
const Checkbox = ({ labelOrientation = "left", label, scale = scales$6.MD, colorVariant = "light", id, defaultChecked, onChange, value, disabled, inputMargin, checkboxPosition, }) => {
...
const Container = styled__default["default"].div.attrs({ position: "bottom" }) `
  position: relative;
  width: 100%;
  ...
  ${styledSystem.space}
`;
const DropdownTop = styled__default["default"].div `
  display: flex;
  align-items: center;
  width: 100%;
  height: 100%;
...
const Label$1 = styled__default["default"].span `
  flex-grow: 1;
`;
const StyledArrow = styled__default["default"](Icon$3B) `
...
const DropdownContent = styled__default["default"].div `
  ...
  bottom: ${getBottom};
  z-index: 101;
  box-shadow: ${({ position }) => position === "bottom"
...
`;
const Dropdown = ({ position = "bottom", children, maxWidth, minWidth, scale, variant, disabled, options, onChange, ...props }) => {
    ...
    return (React__default["default"].createElement(Container, { maxWidth: maxWidth, minWidth: minWidth, ref: wrapperRef, scale: scale, ...props },
        ...
        isOpen && (React__default["default"].createElement(DropdownContent, { position: position, scale: scale }, options.map((option) => (React__default["default"].createElement(DropdownItem, { scale: scale, selected: option.label === selectedOption.label, onClick: onOptionClicked(option), key: option.label },
...
const Heading = styled__default["default"](Text).attrs({ bold: true, as: tags.H2 }) `
  font-size: ${({ scale }) => style[scale || scales$4.MD].fontSize};
  font-weight: 600;
  line-height: 1.1;

  ${({ theme }) => theme.mediaQueries.lg} {
    font-size: ${({ scale }) => style[scale || scales$4.LG].fontSize};
  }
`;
...
const Input$1 = styled__default["default"].input.attrs({
    isError: false,
    isWarning: false,
}) `
  display: block;
...
`;
const InputGroup = ({ scale = scales$3.MD, startIcon, startImage, endIcon, children, variant, isError, isWarning, disabled, description, baseAwsUrl = "https://static.biswap.org/bs", ...props }) => {
...
const LinkExternal = ({ children, ...props }) => {
    return (React__default["default"].createElement(Link, { external: true, ...props },
        children,
        React__default["default"].createElement(Icon$3n, { color: props.color ? props.color : "primary", width: "16px", ml: "4px" })));
};
...
const StyledText$1 = styled__default["default"](Text) `
  transition: color 0.4s ease-in-out;
`;
const Radio = ({ labelOrientation = "left", label, scale = scales$1.MD, radioName, onChange, colorVariant = "light", checked, }) => {
...
const SliderContainer = styled__default["default"](Box) `
  ...
  margin-bottom: 24px;
`;
const BarBackground$1 = styled__default["default"].div `
  width: 100%;
  height: 4px;
  border-radius: 100px;
  opacity: 0.16;
...
`;
const BarProgress$1 = styled__default["default"].div `
...
const BunnySlider = styled__default["default"].div `
  ...
  width: 100%;
`;
const BreakPointsWrap = styled__default["default"].div `
  display: flex;
  justify-content: space-between;
  position: absolute;
  width: 100%;
...
const PercentageAmount = styled__default["default"](Text) `
  ...
  font-weight: 600;
`;
const InfoNode = styled__default["default"].div `
  display: flex;
...
const RBPrice = styled__default["default"](Text) `
  ...
  color: ${({ theme }) => theme.colors.gray900};
`;
const PercentWrap = styled__default["default"].div `
  width: calc(100% - 20px);
  margin: 0 10px;
  position: relative;
  background: transparent;
...
const Root = styled__default["default"].div `
  ...
  display: block;
  background-color: ${({ theme }) => getRgba(theme.colors.pastelBlue, theme, 0.16)};
  border-radius: ${({ variant, theme }) => variant === variants$2.CIRCLE ? theme.radii.circle : theme.radii.small};
...
`;
const Skeleton = ({ variant = variants$2.RECT, animation: animation$1 = animation.PULSE, ...props }) => {
...
const StyledMenuItemContainer = styled__default["default"].div `
  position: relative;
...
const MenuItem = ({ children, href, isActive = false, variant = "default", statusColor, highlightTitle, ...props }) => {
    ...
    return (React__default["default"].createElement(StyledMenuItemContainer, { "$isActive": isActive, "$variant": variant },
        ...
        // @ts-ignore
        , { ...itemLinkProps, "$isActive": isActive, "$variant": variant, "$statusColor": statusColor, "$highlightTitle": highlightTitle, ...props }, children)));
};
...
const Toggle = ({ checked, defaultColor = "toggleBg", checkedColor = "success", scale = scales.MD, disabled, label, labelOrientation, gridArea, variant = "light", spaceBetween, labelSize = "size12", ...props }) => {
...
const BadgeTypesContainer$1 = {
    [badgeTypes$1.SUCCESS]: {
        backgroundColor: "success",
        color: "white",
        border: "0",
    },
    ...
    [badgeTypes$1.WARNING]: {
        backgroundColor: "warning",
        color: "dark800",
        border: "0",
    },
    [badgeTypes$1.PRIMARY]: {
        backgroundColor: "primary",
        color: "white",
        border: "0",
    },
...
const getBadgeBg = ({ badgeType = "light", theme }) => {
    if (badgeType === "active") {
...
const getBadgeColor = ({ badgeType = "light", theme }) => {
    if (badgeType === "active") {
        return theme.colors.success;
    }
    if (badgeType === "notActive") {
...
`;
const Badge$1 = ({ children, badgeType, fontSize, fontWeight, isIcon, isLarge, ...props }) => {
    return (React__default["default"].createElement(Wrapper$c, { badgeType: badgeType, isIcon: isIcon, isLarge: isLarge, fontSize: fontSize, fontWeight: fontWeight, ...props }, children));
};
...
const CircleIcon = (props) => {
    ...
    return (React__default["default"].createElement(Svg, { viewBox: "0 0 10 10", ...props },
        React__default["default"].createElement("rect", { x: "1.5", y: "1.5", width: "7", height: "7", rx: "3.5", fill: props.darkMode ? theme.colors.dark700 : "white", stroke: getColor({ color: props.color, theme }), strokeWidth: "3" })));
};

const PercentSlider = ({ name = "slider", min = 0, max = 100, value, onValueChanged, disabled = false, enableShortcuts, shortcutCheckpoints = [0, 25, 50, 75, 100], withTooltip, bannerPosition = "bottom", darkMode = false, shortcutScale = "sm", shortcutVariant = "primary", numberOfPoints = 5, ...props }) => {
...
const PaginationWrap = styled__default["default"].div `
  display: flex;
  justify-content: center;
...
const GiftWrap = styled__default["default"](Flex) `
  ...
  right: 0;
`;
const SocialShareButton = ({ social = socials$1.TELEGRAM, link, name, message, scale = "lg", target = "_blank", width = "auto", withGift, disabled, ...props }) => {
    const theme = styled.useTheme();
...
const PromotedGradient = styled.keyframes `
  0% {
...
const StyledCard = styled__default["default"].div `
  ...
  border-radius: ${({ theme }) => theme.radii.card};
  color: ${({ theme, isDisabled = false }) => theme.colors[isDisabled ? "gray900" : "gray900"]};
  overflow: hidden;
  position: relative;
  ...
  ${styledSystem.space}
`;
const StyledCardInner = styled__default["default"](Box) `
  width: 100%;
  height: 100%;
...
const Card = ({ ribbon, children, background, ...props }) => {
    return (React__default["default"].createElement(StyledCard, { ...props },
        React__default["default"].createElement(StyledCardInner, { background: background, hasCustomBorder: !!props.borderBackground },
            ribbon,
            children)));
};

const CardBody = styled__default["default"].div.attrs({ p: "24px" }) `
  ${styledSystem.space}
`;

const CardHeader = styled__default["default"].div.attrs({ p: "24px" }) `
  background: ${({ theme, variant = "default" }) => theme.card.cardHeaderBackground[variant]};
  border-radius: ${({ theme }) => `${theme.radii.card} ${theme.radii.card} 0 0`};
  ${styledSystem.space}
`;

const CardFooter = styled__default["default"].div.attrs({ p: "24px" }) `
...
const QuestionWrapper = styled__default["default"](Flex) `
  ...
  ${({ showTooltip }) => showTooltip &&
    ...
    `}
`;
const TooltipHelper = ({ text, placement = "auto", size = "16px", color = "pastelBlue", trigger, Icon = Icon$2W, ml = "4px", children, showTooltip = true, ...props }) => {
...
const TableCardSkeleton = ({ viewMode = ViewMode.CARD, number = 6, tableHeight = "72px", cardHeight = "352px", }) => {
    ...
    return (React__default["default"].createElement(Box, { overflow: "hidden", borderRadius: "16px" }, Array.from({ length: number }, (v, i) => i).map((item) => (React__default["default"].createElement(Skeleton, { key: item.toString(), animation: "waves", height: tableHeight, width: "100%", my: "2px" })))));
};
...
const Wrapper$8 = styled__default["default"](Box) `
  ...
  border: 1px solid
    ${({ theme, isOpen }) => isOpen ? getRgba(theme.colors.primary, theme, 0.16) : "transparent"};
  border-radius: 8px;
  cursor: pointer;
...
`;
const StyledChevronIcon = styled__default["default"](({ ...props }) => (React__default["default"].createElement(Icon$3B, { ...props }))) `
...
`;
const FaqAccordion = ({ name = "", isOpened, handleToggle, variant = "dark", children, }) => {
...
`;
const Faqs = ({ title = "FAQs", leftData, rightData, variant = "dark", blogFAQ = false, titlePosition = "start", ...props }) => {
...
const ModalCloseButton = ({ onDismiss, closeBtnColor }) => {
    return (React__default["default"].createElement(IconButton, { variant: "text", onClick: onDismiss, scale: "sm", "aria-label": "Close the dialog" },
        React__default["default"].createElement(Icon$36, { color: closeBtnColor || "dark600", width: "24px" })));
};
const ModalBackButton = ({ onBack, closeBtnColor }) => {
    return (React__default["default"].createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
        React__default["default"].createElement(Icon$3p, { color: closeBtnColor || "primary" })));
};
...
const Modal = ({ title, onDismiss: onDismiss_, onBack, hideOnBack, children, hideCloseButton = false, bodyPadding, headerPadding, minWidth = "320px", modalBackground = "white", closeBtnColor, maxWidth = "420px", titleSize = "lg", walletModal, modalBodyProps, hideHeader, titleColor = "backgroundDark", ...props }) => {
    const theme = styled.useTheme();
    const { isMobile } = useMatchBreakpoints();
...
const ModalWithBackground = ({ onDismiss: onDismiss_, children, hideCloseButton = false, backBtnColor, background, backgroundTransparent, p, ...boxProps }) => {
    ...
    return (React__default["default"].createElement(StyledModal, { backgroundTransparent: backgroundTransparent, ...boxProps },
        !hideCloseButton && (React__default["default"].createElement(StyledIconButton, { variant: "text", className: "closeModal", scale: "sm", onClick: onDismiss, "aria-label": "Close the dialog" },
            React__default["default"].createElement(Icon$36, { width: "24px", color: backBtnColor ?? "card" }))),
...
const FlagWrap = styled__default["default"].div `
  ...
  height: 14px;
`;
const Community = ({ iconSize = "20px", title, menuVariant, isFooter = false, socialLinks, baseAwsUrl, }) => {
...
const InnerLinksBlockContainer = styled__default["default"].div `
  padding-top: 16px;
...
`;
const DropdownMenuInnerLinkItem = styled__default["default"].div `
...
const DropdownInternalMenuItem = styled__default["default"](reactRouterDom.Link) `
  ${CommonLinkStyle}
`;
const StyledDropdownMenuItemContainer = styled__default["default"].div `
  position: relative;
  margin-bottom: 24px;
...
styled__default["default"](Text) `
  ...
  margin-left: 8px;
`;
const BannerPlacementItem = styled__default["default"].div `
...
const InnerLinksBlock = ({ links, leftIcon, setIsOpen, linkComponent, lastItem, }) => {
    ...
    const renderLinks = () => links.map(({ label = "", href = "/", icon = "ChevronRight", linkType = exports.DropdownMenuItemType.INTERNAL_LINK, mobileTarget, target, fill = "primary", badgeTitle, badgeType, }, index) => {
        const getLinkContent = () => (React__default["default"].createElement(React__default["default"].Fragment, null,
            ...
            badgeTitle && (React__default["default"].createElement(Badge$1, { ml: "4px", badgeType: badgeType ?? "success" }, badgeTitle))));
...
const DropdownMenuItemContainer = ({ isActive = false, leftIcon, getMenuItemContent, links = [], setIsOpen, linkComponent, href = "/", bannerRenderer, type, target, mobileTarget, badgeTitle, badgeType, isOpenItem, lastItem, ...itemProps }) => {
...
const IconComponentWrap = styled__default["default"].div `
  display: flex;
  align-items: center;
  justify-content: center;
  background: ${getBG};
...
/* eslint-disable react/no-array-index-key */
const DropdownMenu = ({ children, isMobileNav = false, showItemsOnMobile = false, activeItem = "", items = [], mobileItems = [], index, isExtended = false, setMenuOpenByIndex, mobileMenuCallback, ...props }) => {
    const { linkComponent } = React.useContext(MenuContext);
    const [isOpen, setIsOpen] = React.useState(false);
    ...
    return (React__default["default"].createElement(Box, { ref: setTargetRef, ...props },
        ...
        hasItems && (React__default["default"].createElement(StyledDropdownMenu, { style: styles.popper, ref: setTooltipRef, ...attributes.popper, "$isOpen": isOpen, "$isExtended": isExtended && hasMoreThanItems }, items.map(({ type = exports.DropdownMenuItemType.INTERNAL_LINK, label, rightIconFill, description, href = "/", status, leftIcon = "", rightIcon = "", links = [], bannerRenderer, target, mobileTarget, badgeType, badgeTitle, ...itemProps }, itemIndex) => {
            ...
            const lastItem = itemIndex === items?.length - 1 ||
                items[itemIndex + 1]?.type === exports.DropdownMenuItemType.BANNER;
...
const MobileCommunityWrapper = styled__default["default"].div `
  flex: 1;
  display: flex;
  flex-direction: column;
  margin-top: 32px;
`;
const StyledMobileMenu = styled__default["default"].div `
  background-color: ${({ theme }) => theme.card.background};
  width: 100vw;
        ...
        hasItems && (React__default["default"].createElement(StyledMobileMenu, { style: styles.popper, ref: setTooltipRef, ...attributes.popper, "$isOpen": isOpen },
            React__default["default"].createElement(Box, null,
                items
                    ...
                    .map(({ label, items: innerItems = [], showItemsOnMobile, hidden, showNavBadge, href, highlightTitle, }, index) => {
                    ...
                    const visualize = !showItemsOnMobile ||
                    ...
                    return (React__default["default"].createElement(BorderMobileMenuItem, { key: `${label}#${index}`, isHighlighted: isHighlighted },
                        React__default["default"].createElement(Accordion, { index: index, label: label, href: href, linkComponent: linkComponent, setIsOpenMenu: setIsOpen, currentOpen: currentOpen, setCurrentOpen: setCurrentOpen, clickable: !isTablet && innerItems.length > 0, isOpenItem: isOpenAccordion, heading: (opened) => {
                            ...
                            .map(({ type = exports.DropdownMenuItemType.INTERNAL_LINK, label, rightIconFill, description, href = "/", status, leftIcon = "", rightIcon = "", links = [], badgeTitle, badgeType, bannerRenderer, ...itemProps }, itemIndex, arr) => {
                            const getMenuItemContent = (icon = rightIcon) => (React__default["default"].createElement(MenuItemContent, { label: label, fill: rightIconFill, leftIcon: leftIcon, rightIcon: icon, description: description, status: status, badgeTitle: badgeTitle, badgeType: badgeType, ...itemProps }));
                            const isActive = href === activeItem;
                            const lastItem = itemIndex === arr?.length - 1;
                            return (visualize && (React__default["default"].createElement(DropdownMenuItemContainer, { label: label, key: itemIndex, isActive: isActive, leftIcon: leftIcon, getMenuItemContent: getMenuItemContent, links: links, setIsOpen: setIsOpen, linkComponent: linkComponent, href: href, bannerRenderer: bannerRenderer, type: type, badgeTitle: badgeTitle, badgeType: badgeType, isOpenItem: isOpenAccordion, lastItem: lastItem, ...itemProps })));
                        })))),
...
const MenuItems = ({ items = [], activeItem, activeSubItem, isMobileMenuOpened = false, mobileMenuCallback, baseAwsUrl, children, ...props }) => {
    ...
    return (React__default["default"].createElement(Flex, { ...props, alignItems: "center" },
        ...
        items.map(({ label, items: menuItems = [], href, icon = "", isExtended, showItemsOnMobile, type, hidden, showNavBadge, highlightTitle, }, index) => {
            const isMarker = items[index]?.showNavBadge;
            const isMarkerColor = items[index]?.colorNavBadge;
            const isHighlighted = items[index].highlightTitle;
            const statusColor = menuItems?.find((menuItem) => menuItem.status !== undefined)?.status?.color;
            const isActive = activeItem === href;
            const linkProps = isTouchDevice() && menuItems && menuItems.length > 0
                ? {}
                : { href };
...
const Logo = ({ href, logoSubtitle }) => {
    ...
    return (React__default["default"].createElement(Flex, null, isAbsoluteUrl ? (React__default["default"].createElement(StyledInnerButton, { variant: "light", onClick: () => window.open(href, "_self"), "aria-label": "Biswap home page" },
...
`;
const ToastAction = ({ title, telegramDescription, tweeterDescription, url, thx, withGift, }) => {
...
const ClearAllButton = styled__default["default"](Button) `
  ...
  margin: 0;
`;
const StyledToast$1 = styled__default["default"].div `
  left: 50%;
...
`;
const LinkWrapper = styled__default["default"].div `
  display: flex;
  align-items: center;
  margin: 6px 0;
`;
...
styled__default["default"].div `
  ...
  flex-direction: row;
`;
const ActionContainer = styled__default["default"].div `
  width: 100%;
`;
const Toast = ({ removeButtonPosition = 60, clearAll, toast, style, handleMouseEnter, handleMouseLeave, handleRemove, progress, clearAllLabel, viewBscScanLabel, ...props }) => {
    ...
    return (React__default["default"].createElement(reactTransitionGroup.CSSTransition, { timeout: 250, style: style, ...props },
        React__default["default"].createElement(StyledToast$1, { onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave },
            clearAll && (React__default["default"].createElement(ClearAllButton, { scale: "sm", variant: "text", top: removeButtonPosition, onClick: () => clearAll() },
            ...
            React__default["default"].createElement(Alert, { progress: progress, title: title, variant: alertTypeMap[type], onClick: handleRemove },
                React__default["default"].createElement("div", null,
                    hash && (React__default["default"].createElement(LinkWrapper, null,
                        ...
                        React__default["default"].createElement(Icon$3n, { ml: "6px", width: "18px", height: "18px", color: "primary" }))),
                    description ? (React__default["default"].createElement(Text, { color: isExtensionConflict ? "gray900" : "#6B7D98", fontSize: "12px", as: "p", mb: isExtensionConflict ? "0" : "8px" }, description)) : (React__default["default"].createElement(React__default["default"].Fragment, null)),
                    telegramDescription && tweeterDescription && (React__default["default"].createElement(ActionContainer, null,
                        React__default["default"].createElement(ToastAction, { withGift: withGift, telegramDescription: telegramDescription, tweeterDescription: tweeterDescription, title: title, url: url, thx: `https://bscscan.com/tx/${hash}` }))))))));
};

const ZINDEX = 1000;
const BOTTOM_POSITION = 120; // Initial position from the bottom
const StyledToastContainer$1 = styled__default["default"].div `
  .enter,
  .appear {
    opacity: 0.01;
  }
...
const StyledToast = styled__default["default"](Box) `
  ...
  background: ${({ theme, type }) => type === coloredVariants.DANGER
...
exports.ArrowDownIcon = Icon$3o;
exports.ArrowFiguredIcon = Icon$i;
exports.ArrowLeftIcon = Icon$3p;
exports.ArrowRightIcon = Icon$3r;
exports.ArrowSkipLeftIcon = Icon$3l;
exports.ArrowSkipRightIcon = Icon$3m;
exports.ArrowUpForwardIcon = Icon$3n;
exports.ArrowUpIcon = Icon$3q;
exports.AuctionIcon = Icon$29;
exports.AuctionOpacityIcon = Icon$27;
exports.AuctionSolidIcon = Icon$28;
...
exports.BellOpacityIcon = Icon$2y;
exports.BellSolidIcon = Icon$2z;
exports.BlockIcon = Icon$1Z;
exports.BlockOpacityIcon = Icon$1Y;
exports.BlockSolidIcon = Icon$1X;
exports.BlogOpacityIcon = Icon$E;
exports.BlogSolidIcon = Icon$F;
exports.BodyText = BodyText;
exports.BookIcon = Icon$2f;
exports.BookOpacityIcon = Icon$2d;
exports.BookSolidIcon = Icon$2e;
exports.Box = Box;
...
exports.CalculateIcon = Icon$2_;
exports.CalculateOpacityIcon = Icon$30;
exports.CalculateSolidIcon = Icon$2$;
exports.CalendarIcon = Icon$2Z;
exports.Card = Card;
exports.CardBody = CardBody;
exports.CardFooter = CardFooter;
exports.CardHeader = CardHeader;
exports.CardViewIcon = Icon$2I;
...
exports.CheckCircleIcon = Icon$2E;
exports.CheckIcon = Icon$2F;
exports.CheckOpacityIcon = Icon$2C;
exports.CheckSolidIcon = Icon$2D;
...
exports.ChevronDownTripleIcon = Icon$3i;
exports.ChevronLeftCircleOpacityIcon = Icon$3w;
exports.ChevronLeftCircleSolidIcon = Icon$3x;
exports.ChevronLeftIcon = Icon$3v;
exports.ChevronRightCircleOpacityIcon = Icon$3z;
exports.ChevronRightCircleSolidIcon = Icon$3A;
exports.ChevronRightIcon = Icon$3y;
exports.ChevronRightTripleIcon = Icon$3h;
exports.ChevronUpCircleOpacityIcon = Icon$3s;
exports.ChevronUpCircleSolidIcon = Icon$3t;
exports.ChevronUpDoubleIcon = Icon$3k;
exports.ChevronUpIcon = Icon$3u;
exports.ChevronUpTripleIcon = Icon$3j;
exports.ClickableElementContainer = ClickableElementContainer;
exports.CloseCircleIcon = Icon$35;
exports.CloseCircleOpacityIcon = Icon$34;
exports.CloseCircleSolidIcon = Icon$33;
exports.CloseIcon = Icon$36;
...
exports.CopyIcon = Icon$2o;
exports.CopyOpacityIcon = Icon$2m;
exports.CopySolidIcon = Icon$2n;
exports.CrossChainOpacityIcon = Icon$1k;
...
exports.EyeCloseIcon = Icon$2G;
exports.EyeOpenIcon = Icon$2H;
exports.FacebookIcon = Icon$q;
exports.Faqs = Faqs;
exports.FarmsOpacityIcon = Icon$1g;
exports.FarmsSolidIcon = Icon$1h;
exports.FavoriteEmptyIcon = Icon$2L;
exports.FavoriteSolidIcon = Icon$2K;
exports.FileIcon = Icon$2c;
exports.FileOpacityIcon = Icon$2a;
exports.FileSolidIcon = Icon$2b;
exports.FilterIcon = Icon$2i;
exports.FilterOpacityIcon = Icon$2g;
exports.FilterSolidIcon = Icon$2h;
exports.FireIcon = Icon$2V;
exports.FireOpacityIcon = Icon$2T;
exports.FireSolidIcon = Icon$2U;
exports.FixedStakingOpacityIcon = Icon$12;
exports.FixedStakingSolidIcon = Icon$13;
exports.FlagIcon = Icon$20;
exports.FlagOpacityIcon = Icon$1$;
exports.FlagSolidIcon = Icon$1_;
exports.Flex = Flex;
...
exports.HelpIcon = Icon$2W;
exports.HelpOpacityIcon = Icon$2Y;
exports.HelpSolidIcon = Icon$2X;
...
exports.Image = Image;
exports.InfoIcon = Icon$2S;
exports.InfoOpacityIcon = Icon$2Q;
exports.InfoSolidIcon = Icon$2R;
...
exports.Menu = Menu;
exports.MinusCircleOpacityIcon = Icon$3b;
exports.MinusCircleSolidIcon = Icon$3c;
exports.MinusIcon = Icon$3d;
exports.Modal = Modal;
...
exports.MoreHorizontalIcon = Icon$1T;
exports.MoreHorizontalOpacityIcon = Icon$1R;
exports.MoreHorizontalSolidIcon = Icon$1S;
exports.MoreVerticalIcon = Icon$1W;
exports.MoreVerticalOpacityIcon = Icon$1U;
exports.MoreVerticalSolidIcon = Icon$1V;
...
exports.OptionsOpacityIcon = Icon$2r;
exports.OptionsSolidIcon = Icon$2s;
...
exports.PlusCircleOpacityIcon = Icon$3e;
exports.PlusCircleSolidIcon = Icon$3f;
exports.PlusIcon = Icon$3g;
...
exports.SearchOpacityIcon = Icon$2w;
exports.SearchSolidIcon = Icon$2x;
exports.ShareIcon = Icon$2l;
exports.ShareOpacityIcon = Icon$2j;
exports.ShareSolidIcon = Icon$2k;
...
exports.StarIcon = Icon$2v;
exports.StarOpacityIcon = Icon$2u;
exports.StarSolidIcon = Icon$2t;
exports.SubMenu = SubMenu;
exports.SubMenuContainer = SubMenuContainer;
exports.SubMenuItem = SubMenuItem;
exports.SubMenuItems = SubMenuItems;
exports.Svg = Svg;
exports.SwapHorizontalOpacityIcon = Icon$2P;
exports.SwapHorizontalSolidIcon = Icon$2O;
exports.SwapVerticalOpacityIcon = Icon$2N;
exports.SwapVerticalSolidIcon = Icon$2M;
...
exports.Terms = Terms;
exports.TestIcon = Icon$23;
exports.TestOpacityIcon = Icon$22;
exports.TestSolidIcon = Icon$21;
exports.Text = Text;
exports.Ticket2Icon = Icon$h;
exports.TikTokIcon = Icon$p;
exports.TimerIcon = Icon$26;
exports.TimerOpacityIcon = Icon$24;
exports.TimerSolidIcon = Icon$25;
...
exports.UserOpacityIcon = Icon$2A;
exports.UserSolidIcon = Icon$2B;
exports.VerifiedOpacityIcon = Icon$2p;
exports.VerifiedSolidIcon = Icon$2q;
exports.ViewMode = ViewMode;
exports.VotingOpacityIcon = Icon$_;
exports.VotingSolidIcon = Icon$$;
exports.WalletOpacityIcon = Icon$31;
exports.WalletSolidIcon = Icon$32;
exports.WarningCycleIcon = Icon$37;
exports.WarningIcon = Icon$38;
exports.WarningOpacityIcon = Icon$3a;
exports.WarningSolidIcon = Icon$39;
