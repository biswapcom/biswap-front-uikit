...
var StyledModal = styled__default["default"](Flex)(templateObject_1$q || (templateObject_1$q = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  background-color: ", ";\n  border-radius: 16px 16px 0 0;\n  width: auto;\n  z-index: ", ";\n  overflow-y: auto;\n  position: absolute;\n  bottom: 0;\n\n  ", " {\n    position: relative;\n    width: auto;\n    min-width: 416px;\n    max-width: 100%;\n    border-radius: 16px;\n  }\n"], ["\n  display: flex;\n  flex-direction: column;\n  background-color: ", ";\n  border-radius: 16px 16px 0 0;\n  width: auto;\n  z-index: ", ";\n  overflow-y: auto;\n  position: absolute;\n  bottom: 0;\n\n  ", " {\n    position: relative;\n    width: auto;\n    min-width: 416px;\n    max-width: 100%;\n    border-radius: 16px;\n  }\n"])), function (_a) {
...
var ModalWithBackground = function (_a) {
    ...
    var context = React.useContext(ModalV2Context);
    var onDismiss = (context === null || context === void 0 ? void 0 : context.onDismiss) || onDismiss_;
    return (React__default["default"].createElement(StyledModal, __assign({ backgroundTransparent: backgroundTransparent }, boxProps),
